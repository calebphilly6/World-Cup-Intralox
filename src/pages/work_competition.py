...
def _score_breakdown_card(score: TeamScore) -> str:
    ...
    return (
        ...
        f'<div><span>Round of 32</span><strong>{knockout["won_round_of_32"]}</strong></div>'
        f'<div><span>Round of 16</span><strong>{knockout["won_round_of_16"]}</strong></div>'
        f'<div><span>Quarterfinals</span><strong>{knockout["won_quarterfinal"]}</strong></div>'
        f'<div><span>Semifinals</span><strong>{knockout["won_semifinal"]}</strong></div>'
        f'<div><span>Final</span><strong>{knockout["won_final"]}</strong></div>'
        '</div>'
